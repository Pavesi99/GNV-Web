...
namespace GNV_Web.Controllers
{
    public class EnderecoesController : Controller
    {
        ...
        public EnderecoesController(GNV_WebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Id_Bairro,Rua,Numero,Complemento,Referencia,CEP")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Id_Bairro,Rua,Numero,Complemento,Referencia,CEP")] Endereco endereco)
        {
            if (id != endereco.Id)
            {
                return NotFound();
